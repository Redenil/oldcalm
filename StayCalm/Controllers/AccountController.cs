...
using StayCalm.Models.Account;
using StayCalm.Models;
using StayCalm.Models.Manage;
using StayCalm.Helpers;
using System.Collections.Generic;
using StayCalm.Models.Common;
using StayCalm.Infrastructure;

namespace StayCalm.Controllers
{
    [Authorize]
    public class AccountController : BaseController
    {
        ...
        {
            var user = UserManager.Users.SingleOrDefault(p => p.Id == id);
